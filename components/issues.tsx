...
const issues: { title: string; answer: string }[] = [
  {
    title: "Game crashes upon opening the AIO",
    answer: `
  ...
  {
    title: "Address wasn't found for this feature",
    answer: `
  ...
  {
    title: "What dependencies do I need for the AIO?",
    answer: `
      <p>You just need <a style='text-decoration: underline' target=_blank href='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-8.0.4-windows-x64-installer'>Dot NET 8.0.4</a>.</p>
  `,
  },
  {
    title:
  ...
  {
    title: "Game doesn't launch without AIO even though I used it before",
    answer: `
  ...
  {
    title: "I opened AIO, but I can't access anything",
    answer: `
  ...
  {
    title: "What could I get banned for?",
    answer: `
  ...
  {
    title: "I have gotten a ban, what now?",
    answer: `
  ...
  {
    title: "How do I know I can trust AIO?",
    answer: `
  ...
  {
    title: "I decided to give it a try, would versions matter?",
    answer: `
      <p>Yes, it does. Please visit <a href="#3" style='text-decoration: underline'>issue NO3</a>.</p>
    `,
  },
  {
    title: "Will there be FH3 support in the future?",
    answer: `
...
export default function Issues() {
  ...
  useEffect(() => {
    setCurrentSelected(window.location.hash.replace("#", ""));
    var ele = document.getElementById(window.location.hash.replace("#", ""));
    if (ele != null) {
      window.scrollTo(ele.offsetLeft,ele.offsetTop); 
    }
  }, [params]);

  function changeIndexTo(index: number) {
    setCurrentSelected((index + 1).toString());
