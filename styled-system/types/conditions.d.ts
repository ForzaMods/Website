...
export interface Conditions {
	...
	"2xl": string
	/** `@media screen and (min-width: 96rem) and (max-width: 106.2475rem)` */
	"2xlOnly": string
	...
	/** `@media screen and (min-width: 106.25rem)` */
	"3xlOnly": string
	/** `@media screen and (max-width: 106.2475rem)` */
	"3xlDown": string
	/** `@media screen and (min-width: 40rem) and (max-width: 47.9975rem)` */
	"smToMd": string
	...
	"smTo2xl": string
	/** `@media screen and (min-width: 40rem) and (max-width: 106.2475rem)` */
	"smTo3xl": string
	/** `@media screen and (min-width: 48rem) and (max-width: 63.9975rem)` */
	"mdToLg": string
	...
	"mdTo2xl": string
	/** `@media screen and (min-width: 48rem) and (max-width: 106.2475rem)` */
	"mdTo3xl": string
	/** `@media screen and (min-width: 64rem) and (max-width: 79.9975rem)` */
	"lgToXl": string
	/** `@media screen and (min-width: 64rem) and (max-width: 95.9975rem)` */
	"lgTo2xl": string
	/** `@media screen and (min-width: 64rem) and (max-width: 106.2475rem)` */
	"lgTo3xl": string
	/** `@media screen and (min-width: 80rem) and (max-width: 95.9975rem)` */
	"xlTo2xl": string
	/** `@media screen and (min-width: 80rem) and (max-width: 106.2475rem)` */
	"xlTo3xl": string
	/** `@media screen and (min-width: 96rem) and (max-width: 106.2475rem)` */
	"2xlTo3xl": string
