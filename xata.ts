...
const tables = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "modPath", type: "string" },
      { name: "additional", type: "multiple" },
...
export type UserMods = InferredTypes["userMods"];
export type UserModsRecord = UserMods & XataRecord;
...
const defaultOptions = {
  databaseURL:
    "https://Davs-s-workspace-elc42b.eu-central-1.xata.sh/db/forzamods-website",
};
